...
import { fetchId, fetchCategory, fetchToken } from '../code/get.js';
    ...
    if (res == 401) {
        ...
        //edit
            ...
            if (data.value.closeDate !== null) {
                console.log(data.value.closeDate)
                console.log(dateClose.value = new Date(data.value.closeDate).toLocaleString())
                console.log(dateClose.value = new Date(data.value.closeDate).toLocaleString("ko-KR", { year: "numeric", month: "2-digit", day: "2-digit" }))
...
onBeforeUpdate(() => {
    ...
    if (params.id === undefined) {
        ...
        console.log(data.value.announcementDescription.length)
        if (data.value.announcementDescription.trim() == '') {
        ...
        console.log(datePublish.value)
        console.log(dateClose.value)
        console.log(`cate: ${data.value.announcementCategory}`)
...
let addNew = (async (addNew) => {
    ...
    if (selectedDatePublish <= currentDate) {
        console.log(selectedDatePublish)
...
function changeValue(event) {
    ...
    if (event.target.id === 'publish') {
        ...
        console.log(timePublish.value);
        console.log(data.value.publishDate)
    }
...
<template>
    <div class="flex flex-col ml-16 mr-16">
        ...
        <div class=" pt-12 font-medium">Publish Date</div>
        <div class="flex flex-row">
