...
//    public Announcement() {
//        this.announcementOwner = 1;  // Set a default value
//    }
...
private Integer viewCount;
    ...
    private User announcementOwnerUser;

    @JsonProperty("announcementOwnerUser")
    public String getAnnouncementOwnerUser() {
        if (announcementOwnerUser != null) {
            return announcementOwnerUser.getUsername();
        } else {
            return null;
        }
    }
